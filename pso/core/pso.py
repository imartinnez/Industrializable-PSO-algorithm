...
class PSO:
    def __init__(self, n_particles, fitness_f, dim, constraints, strategy, w, c1, c2,max_iter, topology = "global", tol = 0.0):
    ...
    def generate_particles(self):
        ...
        velocities = np.random.uniform(-abs(high - low), abs(high - low), size=(self.n_particles, self.dim))
        
        self.swarm = s.Swarm(positions, velocities, self.constraints)
